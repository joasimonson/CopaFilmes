...
internal class PartidaBuilder
{
	...
	public PartidaBuilder() => _filmeModelFaker = FilmeModelFaker.Novo();

	internal static PartidaBuilder Novo() => new();
	...
	internal PartidaBuilder ComParticipantes(IEnumerable<FilmeModel> participantes) => ComDesafiante(participantes.First()).ComDesafiado(participantes.Last());
